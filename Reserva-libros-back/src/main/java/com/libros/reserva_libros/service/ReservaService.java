...
public class ReservaService {
    ...
    public Optional<Reserva> pendientesPorCodigo(String codigo){
        return reservaRepository.findByEjemplarCodigoEjemplarAndEstadoIn(codigo, List.of(EstadoReserva.PENDIENTE, EstadoReserva.CON_RETRASO));
    }

    public Reserva devolverReserva(Reserva reservaActualizada) {
        reservaActualizada.setEstado(EstadoReserva.DEVUELTO);
